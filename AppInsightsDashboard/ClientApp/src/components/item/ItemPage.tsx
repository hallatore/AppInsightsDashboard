            ...
            <Container>
                <Header>
                    ...
                    <div>
                        ...
                        <DurationButton duration={ItemDuration.NinetyDays} currentDuration={duration} onClick={() => this.updateDuration(ItemDuration.HundredAndEightyDays)}>180 days</DurationButton>
